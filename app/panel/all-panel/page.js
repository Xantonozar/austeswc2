        ...
        return (
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-bold text-[#7A9080] bg-white px-3 py-1 rounded-full border border-gray-100 shadow-sm">{membersList.length}</span>
                </div>
    ...
    return (
        <div className="p-8 max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-500 pb-20">
            <header className="border-b border-[#D6E4D8] pb-6">
                ...
                <p className="text-[#7A9080] font-medium tracking-wide mt-2">Browse all panel members organized by semester and department</p>
            </header>
            ...
            <div className="space-y-10">
                {coreCouncil.length > 0 && <Section title="Core Council" icon={<Globe className="w-4 h-4 text-[#4A7C59]" />} membersList={coreCouncil} />}
                {byDept.map(dept => (
