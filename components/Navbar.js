      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-1 flex justify-end items-center gap-3">
            <Link href="/join" className="hidden md:flex items-center px-5 py-2 rounded-full text-sm font-bold text-white bg-[#198042] hover:bg-[#1A2B1E] transition-all shadow-md">
              Join
            </Link>
        ...
        <div className="md:hidden fixed top-0 left-0 w-full h-screen bg-green-50 backdrop-blur-3xl z-50">
          <div className="px-6 pt-20 pb-6 flex flex-col items-start">
            ...
            <div className="mt-8 pt-6 border-t border-green-200 w-full space-y-3">
              <Link href="/join" className="flex w-full items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-bold text-white bg-[#198042] hover:bg-[#1A2B1E] transition-all" onClick={toggleMenu}>
                Join
              </Link>
