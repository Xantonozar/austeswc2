    ...
    <nav className="bg-white bg-opacity-70 backdrop-blur-md sticky top-0 z-40 shadow-md">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Right Section: Join & Admin Login Button */}
          <div className="flex-1 flex justify-end items-center gap-3">
            <Link href="/apply" className="hidden md:flex items-center px-5 py-2 rounded-full text-sm font-bold text-white bg-[#198042] hover:bg-[#1A2B1E] transition-all shadow-md">
              Junior Executive
            </Link>
      ...
      {isOpen && (
        <div className="md:hidden fixed top-0 left-0 w-full h-screen bg-green-50 backdrop-blur-3xl z-50">
          <div className="px-6 pt-20 pb-6 flex flex-col items-start">
            ...
            <div className="mt-8 pt-6 border-t border-green-200 w-full space-y-3">
              <Link href="/apply" className="flex w-full items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-bold text-white bg-[#198042] hover:bg-[#1A2B1E] transition-all" onClick={toggleMenu}>
                Junior Executive
              </Link>
              <Link href="/admin/login" className="flex w-full items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 transition-all" onClick={toggleMenu}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                Admin Login
              </Link>
            </div>
