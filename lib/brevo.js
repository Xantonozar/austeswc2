                        ...
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <div style="text-align: center;">
                                    <a href="https://austeswc.org/competetion/check-status" class="btn">Check Status & Pay</a>
                                </div>
                ...
                <html>
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                <p>Dear ${toName || 'Participant'},</p>
                                <p>We have successfully received your payment for <strong>${competitionType.replace('-', ' ').toUpperCase()}</strong> Round ${round}.</p>
                                ${round === 2 ? '<p>Your spot is now officially confirmed. Get ready for the final event!</p>' : '<p>Your payment has been verified. We will contact you soon with further details.</p>'}
